          ...
          <AccordionDetails>
              ...
              <div className={cx('item-title-content-main')}>
                <FormControl sx={{ minWidth: 120 }} size="small" fullWidth>
                  <StyledAutocomplete
                    ...
                    renderInput={(params) => <TextFieldProductEdit {...params} placeholder="Category" fullWidth />}
                  />
                </FormControl>
              </div>
            </div>
            ...
            <div className={cx('item-title-content')}>
              <div className={cx('item-title-content-aside')}>
                ...
                <div className={cx('aside-text-tip')}>
                  <p>You can add a new subcategory or choose from the existing subcategory list.</p>
                </div>
              </div>
