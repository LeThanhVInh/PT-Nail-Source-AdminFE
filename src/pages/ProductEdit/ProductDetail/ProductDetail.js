        ...
        >
          ...
          <AccordionDetails>
            ...
            <div className={cx('item-title-content')}>
              <div className={cx('item-title-content-aside')}>
                ...
                <div className={cx('aside-text-tip')}>
                  <p>
                    Make sure the product description provides a detailed explanation of your product so that it is easy
                    to understand and find your product.
                  </p>
                  <p>
                    It is recommended not to enter info on mobile numbers, e-mails, etc. into the product description to
                    protect your personal data.
                  </p>
                </div>
              </div>
              <div className={cx('item-title-content-main')}>
                <SunEditor defaultValue="<p>Content of the editor.</p>" height="100%" className={cx('suneditor')} />
              </div>
            </div>
            ...
            <div className={cx('item-title-content')}>
              ...
              <div className={cx('item-title-content-main', 'fl-start')}>
                <ButtonCustom variant="outlined" startIcon={<AddIcon sx={{ color: 'var(--text-color)' }} />}>
                  Add Video URL
                </ButtonCustom>
              </div>
            </div>
